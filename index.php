...
$router->addRoute('GET', '/alumni', function () {
    require __DIR__ . '/views/alumni.php';
    exit;
});

$router->addRoute('GET', '/board', function () {
...
$router->addRoute('GET', '/curriculum', function () {
    require __DIR__ . '/views/curriculum.php';
    exit;
});

$router->addRoute('GET', '/e-learning', function () {
    require __DIR__ . '/views/e-learning.php';
    exit;
});

$router->addRoute('GET', '/environment', function () {
    require __DIR__ . '/views/environment.php';
    exit;
});
...
$router->addRoute('GET', '/laboratory', function () {
    require __DIR__ . '/views/laboratory.php';
    exit;
});
...
$router->addRoute('GET', '/media', function () {
